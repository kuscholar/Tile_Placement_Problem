"""
FileName：TestUpdateVisibleBushes.py
Author：kuscholar
Version：0.1
...
class TestUpdateVisibleBushes(unittest.TestCase):
    """
    This function should update the global variable visibleBushes inside class Tiles
    """


    def test_update_visible_bushes1(self):
        """
        ...
        testVisibleBushes = [0, 0, 0, 0]
        testBushesInCell = [3, 5, 3, 0]
        testCells.updateVisibleBushes(testVisibleBushes, testBushesInCell)  # this may not be a correct way to call the function
        self.assertEqual(testVisibleBushes, [3, 5, 3, 0])
